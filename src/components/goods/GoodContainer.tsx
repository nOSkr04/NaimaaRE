    ...
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <Animated.View style={[styles.container, headerStyle]}>
          ...
          <Text style={style.date}>{format(new Date(item.createdAt), "yyyy-MM-dd")}</Text>
        </Animated.View>
      </TouchableOpacity>
        ...
        <View
          ...
          <View style={styles.contentContainer}>
            <View style={styles.contentRoot}>
              <Text style={styles.name}>{item.incomeType}</Text>
              <View style={styles.pointsContainer}>
                <Text style={styles.points}>{item.quantity}</Text>
              </View>
            </View>
            <Text style={style.all}>{item.balanceGoodNumber}</Text>
          </View>
        </View>
      </Animated.View>
