...
import { ProfileHtml } from "./ProfitHtml";
type Props = NativeStackScreenProps<RootStackParamList, "ProfitScreen">;

const ProfitScreen = memo(({ route }: Props) => {
  ...
  const printToFile = async () => {
    ...
    const { uri } = await Print.printToFileAsync({
      html: ProfileHtml({ data: data, date1: date1, date2: date2 }),
    });
  ...
  ProfitScreen.displayName="ProfitScreen";
